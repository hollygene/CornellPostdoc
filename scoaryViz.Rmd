...
get_nt_fasta(cefalexin.comb,"cefalexin.comb")
...
# need to extract the lines that match what isolates we have (the 601 dog genomes that are definitely dogs and we have phenotypic data for)
# get the gene presence-absence matrix in long format 
